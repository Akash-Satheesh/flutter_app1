...
import 'package:flutter_app1/storages/sqflite_ex/sqflite_crud/sql_functions.dart';
...
class _ContactBookState extends State<ContactBook> {
  ...
  Future<void> updateCcontact(int id) async {
  ...
  Future<void> deleteContact(int id) async {
    showDialog<String>(
      ...
      builder: (BuildContext context) => AlertDialog(
        ...
        content: const Text('Do u want to delete the contact!!!'),
        actions: <Widget>[
          TextButton(
